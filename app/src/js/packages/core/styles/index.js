...
export const color11 = '#76dcab';
export const color12 = '#dcf6e9';
...
export const m = (
  ...
  bottom = 0,
  left = 0) =>
  `margin: ${top * FACTOR}px ${right * FACTOR}px ${bottom * FACTOR}px ${left * FACTOR}px`;
...
export const p = (
  ...
  bottom = 0,
  left = 0) =>
  `padding: ${top * FACTOR}px ${right * FACTOR}px ${bottom * FACTOR}px ${left * FACTOR}px`;
